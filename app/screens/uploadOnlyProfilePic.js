...
class uploadOnlyProfilePic extends React.Component{
  constructor(props){
    super(props);
    this.state = {
      loggedin: false,
  ...
  render(){
    return(
      ...
      <Header texto='Upload Profile Picture' />
            ...
            { this.state.selected == true ?(
              <View style = {{flex:1}}>
                ...
                <Image
                  ...
                  style = {{marginVertical: 10, resizeMode: 'cover', width:'100%', height:275}}
                />
              ...
              <Button textoo='Take Photo to Upload' onPress={()=> this.takeImage()}/>
                <Button textoo='Back' onPress={()=> this.cancel()}/>
              </View>
...
export default uploadOnlyProfilePic;
